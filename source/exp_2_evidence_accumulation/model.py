...
class Train():
    def __init__(self, bf:BigField, learning_rate = 3e-4, batch_size = 64, t1 = 40.0, dt = 0.04, num_epochs = 2000, best_model_path = "model/", seed = 0):
        self.bf = bf
...
if __name__ == "__main__":
    ...
    for seed in seeds:
        ...
        train = Train(test,num_epochs=6000, seed=seed)
